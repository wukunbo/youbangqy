...
class GetServiceModel extends Model {
  ...
  public function getJssdkSignature($data) {
    $cache_name = "jssdk_ticket";
    ...
    $cache = $this->get_base_access_token();
    ...
    $back_url = "$protocol$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
    $data[url]=$back_url;
  ...
  public function get_base_access_token($data=array()){
    ...
    $cache_name='access_token'.$this->_appid;
